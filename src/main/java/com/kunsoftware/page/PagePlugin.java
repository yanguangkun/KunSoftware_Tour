        ...
        if (ivk.getTarget() instanceof RoutingStatementHandler) {
            ...
            if (mappedStatement.getId().matches(pageSqlId)) {
                ...
                if (parameterObject == null) {
                    throw new NullPointerException("parameterObject null.");
                } else {
    ...
    private String generatePageSql(String sql, PageInfo page) {
        if (page != null && (dialect !=null || !dialect.equals(""))) {
            ...
            if ("mysql".equals(dialect)) {
                pageSql.append(sql);
                pageSql.append(" limit " + page.getCurrentPageStartRecord() + "," + page.getPageSize());
            } else if ("oracle".equals(dialect)) {
                pageSql.append("select * from (select tmp_tb.*,ROWNUM row_id from (");
                pageSql.append(sql);
                pageSql.append(")  tmp_tb where ROWNUM<=");
                pageSql.append(page.getCurrentPageStartRecord() + page.getCurrentPageStartRecord());
                pageSql.append(") where row_id>");
                pageSql.append(page.getCurrentPageStartRecord());
            }
